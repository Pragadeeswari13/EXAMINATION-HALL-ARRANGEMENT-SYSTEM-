 ...
 -->							<li><a href="javascript:;"><i class="fa fa-envelope-o"></i>Support@website.com</a></li>
					...
					<div class="topbar-right">
						<ul>
							...
							<li><a href="register.html">Exam Co-ordinator</a></li> -->
						</ul>
					</div>
				</div>
			</div>
            ...
            <div class="menu-bar clearfix">
                <div class="container clearfix">
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
						<div class="menu-logo">
							<br>
							<a href="index.php">Exam Seating Arrangement</a>
						</div>
						...
						<li style="padding-left: 0px;">
								<a href="#">
									<h6 style="color: white; font-size: 20px; margin: 0; font-weight:bold;">Exam Seating Arrangement</h6>
								</a>
							</li>
                            ...
                            <li><a href="stafflogin.php">Staff</a>
								
                            </li>
                           <!--  <li><a href="corditorlogin.php">Exam Co-ordinator</a></li> -->
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center"> <a target="_blank" href=""><?php include("include/title.php"); ?></a></div>
                </div>
            </div>
        </div>
    </footer>
