...
if(isset($login))
{
 if(trim($uname=="")) { $msg = "Enter the Username"; }
	 ...
	 {
	$qry = "select * from admin where username='$uname' && password='$pwd' && type='coordinator'";
	$exe=mysql_query($qry);
    ...
    if ($num == 1) {
        ...
        echo "<script>
                ...
                window.location.href='admin/index1.php';
              </script>";
    } else {
        $msg = "Login Incorrect!";
    }
...
<div class="container">
    ...
    <h2 class="login-title">Exam Co-ordinator</h2>
